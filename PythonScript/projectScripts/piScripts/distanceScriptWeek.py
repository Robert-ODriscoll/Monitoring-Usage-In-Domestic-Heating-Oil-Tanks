...
database = MySQLdb.connect(host='ec2-52-215-72-245.eu-west-1.compute.amazonaws.com',user='pi',passwd='Clifden@1',db='project')# link to database
...
cursor.execute(''' INSERT INTO `dailydata`(`epoch`, `temp`,`humidity`,`distance`,`vol`,`percent`) VALUES (%s,%s,%s,%s,%s,%s) ''',(epoch,temperatureAverage,humidityAverage,tankReading,tankVolume,volumePercentage)) ###### inserts data i$
